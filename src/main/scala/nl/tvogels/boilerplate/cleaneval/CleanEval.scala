...
object CleanEval {
  ...
  def iterator: Iterator[CleanEvalEntry] =
    indices.toIterator.map {i => CleanEvalEntry(
      id      = i,
      orig    = loadOrigFile(i),
