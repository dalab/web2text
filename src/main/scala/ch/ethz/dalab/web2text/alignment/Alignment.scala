package ch.ethz.dalab.web2text.alignment

import ch.ethz.dalab.web2text.utilities.Util
import ch.ethz.dalab.web2text.cdom.CDOM
import ch.ethz.dalab.web2text.cdom.NodeProperties
...
/** Alignment of a cleaned page with the original HTML source
  ...
  *
  * Main method [[ch.ethz.dalab.web2text.alignment.Alignment.alignment]]
  *
