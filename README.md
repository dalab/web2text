...
* Feature representations for +70,000 news articles from [All The News](https://www.kaggle.com/snapcrack/all-the-news) under `public/train_and_test` (23.39GB), in CSV format. The corresponding HTML files were not uploaded because it contains material.
* AuthorExtractor Train Model Task
* Weights from a pre-trained model with the above dataset (under `public/trained_model_all_the_news`)
* AuthorExtractor Inference Task
...
### Recipe: Train Model Task

`./train_model.sh`

### Recipe: Inference Task
